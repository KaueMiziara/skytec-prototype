      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div class="space-y-4">
            <a
              routerLink="/"
              class="inline-block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#077fbd] rounded"
            ...
            <p class="text-xs text-neutral-400 leading-relaxed">
              Referência em máquinas de costura industriais, automação fabril e insumos de alta
              produtividade para confecções em todo o Brasil.
            </p>
          ...
          <div>
            <h3
              class="text-xs font-bold uppercase tracking-wider text-white mb-4 pb-2 border-b border-neutral-800"
            >
              Departamentos
            </h3>
            ...
            <ul class="space-y-3 text-xs">
              <li class="flex items-start gap-2.5">
                <svg
                  ...
                  class="w-4 h-4 text-[#077fbd] shrink-0 mt-0.5"
                >
                  <path
              ...
              <li class="flex items-start gap-2.5">
                ...
                <div>
                  <span class="block text-white font-medium"
                    >contato&#64;skytecmaquinas.com.br</span
                  >
              ...
              <li class="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <span class="text-neutral-500 text-[11px]"
                    >08:00 às 18:00 (Horário de Brasília)</span
                  >
                </div>
              </li>
            </ul>
